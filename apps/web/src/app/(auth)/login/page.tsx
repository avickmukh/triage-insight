...
const loginSchema = z.object({
  ...
  // Login only requires non-empty — the server validates the actual password.
  // We do not enforce complexity here to avoid locking out users with old passwords.
          ...
          >
            ...
            <div>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "0.4rem" }}>
                ...
                <Link href="/reset-password" style={{ fontSize: "0.78rem", color: "#20A4A4", textDecoration: "none" }}>
                  Forgot password?
                </Link>
              </div>
              <PasswordInput
