  ...
  const actions = [
    {
      ...
      emoji: '⚡',
      label: 'CIQ Scoring',
      desc: 'Composite business score across feedback, ARR, voice urgency, and support pressure',
      accent: TEAL,
      bg: TEAL_L,
    },
    {
      ...
      emoji: '📈',
      label: 'Theme Ranking',
      desc: 'All active themes ranked by CIQ score — with DRS, eligibility, and trend',
      accent: PURPLE,
      bg: '#faf5ff',
    },
    {
      href: r.prioritizationFeatures,
      emoji: '📊',
      label: 'Feature Priority',
      desc: 'Feature requests ranked by Demand · Revenue Impact · Urgency',
      accent: BLUE,
      bg: '#f0f9ff',
    },
    {
