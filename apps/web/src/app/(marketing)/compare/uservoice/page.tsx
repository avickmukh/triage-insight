export const metadata = { title: "TriageInsight vs UserVoice — TriageInsight" };
      ...
      <section style={{ background: "linear-gradient(135deg, #0A2540 0%, #0d2e4d 50%, #0a3060 100%)", padding: "8rem 0 5rem", position: "relative", overflow: "hidden" }}>
        ...
        <div className="container" style={{ position: "relative", zIndex: 2, textAlign: "center" }}>
          ...
          <h1 style={{ fontSize: "clamp(2.2rem,5vw,3.5rem)", fontWeight: 900, color: "#fff", lineHeight: 1.1, marginBottom: "1.25rem" }}>
            TriageInsight vs <span style={{ color: "#20A4A4" }}>UserVoice</span>
          </h1>
      ...
      <section style={{ background: "#fff", padding: "5rem 0 6rem" }}>
        <div className="container" style={{ maxWidth: 800 }}>
          <p style={{ fontSize: "1.05rem", color: "#6C757D", lineHeight: 1.8, marginBottom: "3rem", maxWidth: 680 }}>
            UserVoice has been around for over a decade and is trusted by large enterprises. But it is expensive, complex to set up, and lacks modern AI capabilities. TriageInsight delivers AI deduplication, revenue-weighted prioritisation, voice feedback, and a weekly digest — all at a price point that works for growing SaaS teams.
          </p>
          ...
          <div style={{ overflowX: "auto" }}>
            <table style={{ width: "100%", borderCollapse: "collapse" }}>
              <thead>
                <tr style={{ borderBottom: "2px solid #0A2540" }}>
                  ...
                  <th style={{ padding: "0.75rem", textAlign: "center", fontSize: "0.8rem", fontWeight: 700, letterSpacing: "0.08em", textTransform: "uppercase", color: "#6C757D" }}>UserVoice</th>
                </tr>
              </thead>
              <tbody>
            ...
            <tr style={{ borderBottom: "1px solid #e9ecef" }}>
              ...
              <td style={{ padding: "1rem 0.75rem", fontSize: "0.9rem", color: "#6C757D", textAlign: "center" }}>Basic scoring only</td>
            </tr>
            <tr style={{ borderBottom: "1px solid #e9ecef" }}>
            ...
            <tr style={{ borderBottom: "1px solid #e9ecef" }}>
              <td style={{ padding: "1rem 0.75rem", fontSize: "0.9rem", color: "#0A2540", fontWeight: 500 }}>Setup time</td>
              <td style={{ padding: "1rem 0.75rem", fontSize: "0.9rem", color: "#20A4A4", fontWeight: 600, textAlign: "center" }}>Under 30 minutes</td>
              <td style={{ padding: "1rem 0.75rem", fontSize: "0.9rem", color: "#6C757D", textAlign: "center" }}>Days to weeks</td>
            </tr>
            <tr style={{ borderBottom: "1px solid #e9ecef" }}>
              ...
              <td style={{ padding: "1rem 0.75rem", fontSize: "0.9rem", color: "#6C757D", textAlign: "center" }}>Salesforce only</td>
            </tr>
            <tr style={{ borderBottom: "1px solid #e9ecef" }}>
              ...
              <td style={{ padding: "1rem 0.75rem", fontSize: "0.9rem", color: "#6C757D", textAlign: "center" }}>$699 / month</td>
            </tr>
              </tbody>
            </table>
          </div>
