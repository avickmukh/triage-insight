export const metadata = { title: "TriageInsight vs Canny — TriageInsight" };
      ...
      <section style={{ background: "linear-gradient(135deg, #0A2540 0%, #0d2e4d 50%, #0a3060 100%)", padding: "8rem 0 5rem", position: "relative", overflow: "hidden" }}>
        ...
        <div className="container" style={{ position: "relative", zIndex: 2, textAlign: "center" }}>
          ...
          <h1 style={{ fontSize: "clamp(2.2rem,5vw,3.5rem)", fontWeight: 900, color: "#fff", lineHeight: 1.1, marginBottom: "1.25rem" }}>
            TriageInsight vs <span style={{ color: "#20A4A4" }}>Canny</span>
          </h1>
          <p style={{ fontSize: "1.15rem", color: "rgba(255,255,255,0.7)", maxWidth: 600, margin: "0 auto 2.5rem" }}>
            Canny is a good feedback board. TriageInsight is an AI-powered feedback intelligence platform.
          </p>
      ...
      <section style={{ background: "#fff", padding: "5rem 0 6rem" }}>
        <div className="container" style={{ maxWidth: 800 }}>
          <p style={{ fontSize: "1.05rem", color: "#6C757D", lineHeight: 1.8, marginBottom: "3rem", maxWidth: 680 }}>
            Canny helps you collect and organise feature requests with a public board and voting. TriageInsight does all of that — and adds AI deduplication, revenue-weighted prioritisation, voice feedback ingestion, and a weekly AI digest. If your team is drowning in feedback and needs to make faster, smarter decisions, TriageInsight is the better choice.
          </p>
          ...
          <div style={{ overflowX: "auto" }}>
            <table style={{ width: "100%", borderCollapse: "collapse" }}>
              <thead>
                <tr style={{ borderBottom: "2px solid #0A2540" }}>
                  ...
                  <th style={{ padding: "0.75rem", textAlign: "center", fontSize: "0.8rem", fontWeight: 700, letterSpacing: "0.08em", textTransform: "uppercase", color: "#6C757D" }}>Canny</th>
                </tr>
              </thead>
              <tbody>
            ...
            <tr style={{ borderBottom: "1px solid #e9ecef" }}>
              ...
              <td style={{ padding: "1rem 0.75rem", fontSize: "0.9rem", color: "#6C757D", textAlign: "center" }}>Limited</td>
            </tr>
            <tr style={{ borderBottom: "1px solid #e9ecef" }}>
              <td style={{ padding: "1rem 0.75rem", fontSize: "0.9rem", color: "#0A2540", fontWeight: 500 }}>HubSpot / Salesforce CRM</td>
              <td style={{ padding: "1rem 0.75rem", fontSize: "0.9rem", color: "#20A4A4", fontWeight: 600, textAlign: "center" }}>Yes — native</td>
              <td style={{ padding: "1rem 0.75rem", fontSize: "0.9rem", color: "#6C757D", textAlign: "center" }}>No</td>
            </tr>
            <tr style={{ borderBottom: "1px solid #e9ecef" }}>
              ...
              <td style={{ padding: "1rem 0.75rem", fontSize: "0.9rem", color: "#6C757D", textAlign: "center" }}>$50 / month</td>
            </tr>
              </tbody>
            </table>
          </div>
