...
export class PrioritizationController {
  ...
  getThemeScoreExplanation(
    ...
    return this.prioritizationService.getThemeScoreExplanation(
      workspaceId,
      themeId,
    );
  }
  ...
  setManualOverride(
    ...
    return this.prioritizationService.setManualOverride(
      workspaceId,
      themeId,
      req.user.sub,
      dto,
  ...
  setStrategicTag(
    ...
    return this.prioritizationService.setStrategicTag(
      workspaceId,
      themeId,
      req.user.sub,
      dto.strategicTag,
  ...
  getPrioritizedFeatures(
    ...
    return this.prioritizationService.getPrioritizedFeatures(
      workspaceId,
      limit,
    );
  }
  ...
  getRoadmapRecommendations(
    ...
    return this.prioritizationService.getRoadmapRecommendations(
      workspaceId,
      limit,
    );
  }
  ...
  recalculateAllThemes(
    ...
    return this.prioritizationService.enqueueWorkspaceRescore(
      workspaceId,
      req.user.sub,
    );
  }
  ...
  updateSettings(
    ...
    return this.prioritizationService.updateSettings(
      workspaceId,
      req.user.sub,
      dto,
    );
